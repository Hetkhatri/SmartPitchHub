...
<div class="dashboard">
    ...
    <div class="dashboard-header">
        ...
        <p>Welcome back, <?php echo htmlspecialchars($_SESSION['username']); ?>! Manage your startup <?php echo htmlspecialchars($_SESSION['startup_name']); ?> and track investor interest.</p>
    </div>
