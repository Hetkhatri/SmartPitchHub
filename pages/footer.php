          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="animate-fade-in" style="animation-delay: 0.1s">
              ...
              <ul class="space-y-2 text-muted-foreground">
                ...
                <li><a href="../Pitches/explorePitches.php" class="hover:text-foreground animated-underline">Browse Pitches</a></li>
            ...
            <div class="animate-fade-in" style="animation-delay: 0.3s">
              ...
              <ul class="space-y-2 text-muted-foreground">
                <li><a href="../about.php" class="hover:text-foreground animated-underline">About Us</a></li>
                <!-- <li><a href="#" class="hover:text-foreground animated-underline">Contact</a></li> -->
                <li><a href="privacy-policy.php" class="hover:text-foreground animated-underline">Privacy Policy</a></li>
                <li><a href="Tac.php" class="hover:text-foreground animated-underline">Terms of Service</a></li>
              </ul>
            </div>
          </div>
          <div class="border-t border-border mt-8 pt-8 text-center text-muted-foreground animate-fade-in" style="animation-delay: 0.4s">
            <p>&copy; 2025 SmartPitchHub. All rights reserved.</p>
          </div>
        </div>
      </footer>