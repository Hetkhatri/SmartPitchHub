     ...
     <header class="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50 animate-slide-up">
        <div class="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div class="flex items-center space-x-3">
            ...
            <button class="inline-flex items-center justify-center rounded-md text-sm font-medium h-10 px-4 py-2 hover:bg-accent hover:text-accent-foreground hover-scale"><a href="login.php">Sign In</a></button>
            <button class="inline-flex items-center justify-center rounded-md text-sm font-medium h-10 px-4 py-2 bg-primary text-primary-foreground hover-scale hover-glow gradient-bg border-0"><a href="register.php">Get Started</a></button>
          </div>
        </div>
      </header>
    <main>
